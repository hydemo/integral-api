...
import { CreateCartDTO, DeleteManyDTO, CountDTO } from 'src/module/cart/cart.dto';
...
export class ApiCartController {
  ...
  async deleteMany(
    ...
    return await this.cartService.deleteMany({ _id: { $in: carts.carts }, user: req.user._id })
  }
