import { Controller, Get, Query, UseGuards, Inject, Post, Put, Param, Body, Delete, } from '@nestjs/common';
import {
  ApiUseTags,
  ApiOkResponse,
...
import { UpdateStockDTO, CreateProductDTO } from 'src/module/product/product.dto';
